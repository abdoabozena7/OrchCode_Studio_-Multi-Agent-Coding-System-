...
function collectRouteSignals(text: string): RouteSignals {
  ...
  const hasProjectQuestion = /\b(explain|inspect|analyze|review|trace|where|why|how|architecture|flow|implemented|works|continue|what.*project|what.*repo)\b/i.test(text)
